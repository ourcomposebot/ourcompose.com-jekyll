...
function () {
  function Darkmode(options) {
    ...
    var defaultOptions = {
      ...
      mixColor: '#fff',
      backgroundColor: '#fff',
      buttonColorDark: '#e56a19',
      buttonColorLight: '#e56a19',
      label: '',
      saveInCookies: true,
      autoMatchOsTheme: false,
      darkmodeLogo: "/assets/logos/LogoWithNameTransparentDark.png",
      lightmodeLogo: "/assets/logos/LogoWithNameTransparent.png"
    };
  ...
  _createClass(Darkmode, [{
      ...
      button.addEventListener('click', function () {
        ...
        if (!isDarkmode) {
          ...
          setTimeout(function () {
            ...
            a.src = options.darkmodeLogo
            button.classList.remove('darkmode-toggle--white')
          }, time);
        } else {
          ...
          setTimeout(function () {
            ...
            button.removeAttribute('disabled');
            var a = document.getElementById('logo')
            a.src = options.lightmodeLogo
            button.classList.remove('darkmode-toggle--dark')
          }, 1);
        }
    ...
    value: function toggle() {
      ...
      var layer = this.layer;
      var isDarkmode = this.isActivated() && this.localStorageLight() == 'false';
    ...
    key: "localStorageLight",
    value: function localStorageLight() {
      if (!IS_BROWSER) {
        return null;
      }
      var localLight = window.localStorage.getItem('darkmode') == 'false'; 
      return localLight;
    }
  }]);
